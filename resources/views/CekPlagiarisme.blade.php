        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-yellow-700 dark:text-yellow-200">
                    Profil Anda belum lengkap. Silakan lengkapi data di halaman <a href="{{ route('profile.edit') }}" class="font-bold underline hover:text-yellow-600">Profil Saya</a> untuk bisa mengunggah dokumen.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="space-y-4 max-h-32 overflow-y-auto pr-2">
                        @foreach($files as $file)
                            <div class="flex justify-between items-center p-4 border rounded-lg dark:border-neutral-700">
                                ...
                                <div>
                                    <a href="{{ route('mahasiswa.view.document', $file->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        Lihat Hasil
                                    </a>
                                </div>
                            </div>
