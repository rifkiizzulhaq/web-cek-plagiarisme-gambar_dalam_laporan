...
@if($user->hasRole('mahasiswa') && (!$user->nim || !$user->prodi || !$user->angkatan || !$user->kelas))
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-yellow-700 dark:text-yellow-200">
                    Profil Anda belum lengkap. Silakan lengkapi data di halaman <a href="{{ route('profile.edit') }}" class="font-bold underline hover:text-yellow-600">Profile</a> untuk bisa mengunggah dokumen.
                </p>
            </div>
        </div>
    </div>
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-sm rounded-xl dark:bg-neutral-800">
        <div class="p-4 sm:p-7">
            ...
            <div class="mt-5">
                {{-- Form Upload --}}
                <form id="uploadForm" action="{{ route('mahasiswa.upload.file') }}" method="POST" enctype="multipart/form-data">
                    @csrf
