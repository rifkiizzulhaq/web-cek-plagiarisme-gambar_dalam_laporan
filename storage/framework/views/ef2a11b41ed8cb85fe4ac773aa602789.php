...
<div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
  ...
  <div class="relative flex flex-col h-full max-h-full">
    <div class="px-6 pt-4 flex items-center">
      <!-- Logo -->
      <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="<?php echo e(route('login')); ?>" aria-label="Preline">
        <img src="<?php echo e(asset('Image/logo_polindra.png')); ?>" alt="Logo" class="w-10 h-auto">
      </a>
      <!-- End Logo -->
    ...
    <div class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
      <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        ...
        <?php if(Auth::user()->role->name === 'admin'): ?>
          ...
          <li>
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg <?php echo e(Request::is('admin/mahasiswa*') ? 'bg-gray-200 dark:bg-neutral-700' : 'hover:bg-gray-100'); ?>" href="<?php echo e(route('admin.mahasiswa.index')); ?>">
        ...
        <?php if(Auth::user()->role->name === 'mahasiswa'): ?>
          <li class="hs-accordion <?php echo e($isDokumenMenuActive ? 'active' : ''); ?>" id="projects-accordion">
            ...
            <div id="projects-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 <?php echo e($isDokumenMenuActive ? '' : 'hidden'); ?>">
              <ul class="pt-2 ps-2">
                  <li>
                      <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm dark:text-white rounded-lg dark:hover:bg-neutral-700 <?php echo e(Request::is('mahasiswa/cek-plagiarisme*') ? 'bg-gray-200 dark:bg-neutral-700' : 'hover:bg-gray-100'); ?>" href="<?php echo e(route('mahasiswa.cek-plagiarisme')); ?>">
                          Cek Plagiarisme
                      </a>
                  </li>
                  <li class="pt-1">
                      <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm dark:text-white rounded-lg dark:hover:bg-neutral-700 <?php echo e(Request::is('mahasiswa/riwayat*') ? 'bg-gray-200 dark:bg-neutral-700' : 'hover:bg-gray-100'); ?>" href="<?php echo e(route('mahasiswa.riwayat')); ?>">
                          Riwayat Unggahan
                      </a>
                  </li>
              </ul>
    ...
    <div id="profile-dropdown-container" class="hs-dropdown relative inline-flex mt-auto [--placement:top-right]">
          ...
          <div class="flex items-center gap-x-3">
            <div class="relative inline-block">
              <?php if(Auth::user()->google_id): ?>
                <!-- Avatar Google -->
                <img class="size-9 rounded-full ring-2 ring-gray-100 dark:ring-gray-700" src="<?php echo e(Auth::user()->avatar); ?>" alt="Profile Picture">
              <?php else: ?>
            ...
            <div class="flex flex-col">
              <span class="text-sm font-semibold text-gray-800 dark:text-white leading-tight truncate max-w-[150px]"><?php echo e(Auth::user()->name); ?></span>
              <span class="text-[11px] font-medium text-gray-600 dark:text-gray-400 leading-tight truncate max-w-[150px]"><?php echo e(Auth::user()->email); ?></span>
            </div>
          </div>
      ...
      <div id="hs-dropdown-account-menu" class="hs-dropdown-menu w-full transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700" role="menu" aria-labelledby="hs-dropdown-account">
        <?php if(Auth::user()->role->name === 'mahasiswa'): ?>
        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300" href="<?php echo e(route('profile.edit')); ?>">
          <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <form method="POST" action="<?php echo e(Auth::user()->role->name === 'admin' ? route('admin.logout') : route('logout')); ?>">
          <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Rifki Izzulhaq\Documents\Skripsi\Project\Web\laravel\example-app\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>