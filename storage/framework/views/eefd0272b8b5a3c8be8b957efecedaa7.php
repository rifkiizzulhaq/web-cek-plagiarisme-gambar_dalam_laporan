    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow flex items-center justify-center">
            <div class="text-center px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-3 text-xl text-gray-600 dark:text-neutral-400">Oops, akses ditolak.</p>
                <p class="text-gray-600 dark:text-neutral-400">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
            </div>
        </main>
...
</html><?php /**PATH C:\Users\Rifki Izzulhaq\Documents\Skripsi\Project\Web\laravel\example-app\resources\views/errors/403.blade.php ENDPATH**/ ?>