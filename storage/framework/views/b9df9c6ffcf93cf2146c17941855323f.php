        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-yellow-700 dark:text-yellow-200">
                    Profil Anda belum lengkap. Silakan lengkapi data di halaman <a href="<?php echo e(route('profile.edit')); ?>" class="font-bold underline hover:text-yellow-600">Profile</a> untuk bisa mengunggah dokumen.
                </p>
            </div>
        </div>
    </div>
    ...
    function uploadFile(file) {
        ...
        const config = {
            onUploadProgress: function(progressEvent) {
                ...
                progressText.textContent = `Mengupload (${percentCompleted}%)...`;
                
                if (percentCompleted === 100) {
                    progressText.textContent = 'Upload selesai. Memproses file di server...';
                }
            },
            headers: {
        ...
        axios.post(form.action, formData, config)
            .then(function (response) {
                ...
                if (data.success) {
                    progressText.textContent = 'Proses berhasil! Mengalihkan...';
                    setTimeout(() => {
                    ...
                    showError(data.message || 'Terjadi kesalahan.', errorData);
                    progressBar.style.width = '0%';
            ...
            .catch(function (error) {
                ...
                showError(errorMessage, responseData);
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rifki Izzulhaq\Documents\Skripsi\Project\Web\laravel\example-app\resources\views/User/cekPlagiarisme/index.blade.php ENDPATH**/ ?>