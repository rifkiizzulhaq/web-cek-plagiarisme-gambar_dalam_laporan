            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div class="border border-gray-200 rounded-lg divide-y divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
                    <div class="py-3 px-4 flex justify-between items-center">
                        ...
                        <form action="<?php echo e(route('admin.mahasiswa.index')); ?>" method="GET">
                            <div class="relative max-w-xs">
                                <label class="sr-only">Search</label>
                                <input type="text" name="search" id="search-input" class="py-1.5 sm:py-2 px-3 ps-9 block w-full border-gray-200 shadow-sm rounded-lg sm:text-sm ..." placeholder="Cari nama atau email..." value="<?php echo e(request('search')); ?>">
                    ...
                    <form id="bulk-delete-form" action="<?php echo e(route('admin.mahasiswa.bulkDestroy')); ?>" method="POST" class="hidden">
                        <?php echo csrf_field(); ?>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                            <?php $__empty_1 = true; $__currentLoopData = $mahasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-3 ps-4">
                                        <div class="flex items-center h-5">
                                            <input id="checkbox-<?php echo e($mahasiswa->id); ?>" type="checkbox" value="<?php echo e($mahasiswa->id); ?>" class="row-checkbox border-gray-200 rounded-sm text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500">
                                            <label for="checkbox-<?php echo e($mahasiswa->id); ?>" class="sr-only">Checkbox</label>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <div class="row-actions invisible opacity-0 transition-opacity duration-300">
                                            <div class="flex justify-end gap-x-2">
                                                <a href="<?php echo e(route('admin.mahasiswa.show', $mahasiswa->id)); ?>" class="text-blue-600 hover:text-blue-800">Riwayat</a>
                                                <a href="<?php echo e(route('admin.mahasiswa.edit', $mahasiswa->id)); ?>" class="text-yellow-600 hover:text-yellow-800">Edit</a>
                                                <form action="<?php echo e(route('admin.mahasiswa.destroy', $mahasiswa->id)); ?>" method="POST" class="delete-form">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($mahasiswas->total() > $mahasiswas->perPage()): ?>
                        <div class="py-1 px-4">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rifki Izzulhaq\Documents\Skripsi\Project\Web\laravel\example-app\resources\views/Admin/mahasiswa/index.blade.php ENDPATH**/ ?>